...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='ultrasoundorder',
            index=models.Index(fields=['status', 'urgency'], name='ultrasound__status_556e8d_idx'),
        ),
        migrations.AddIndex(
            model_name='ultrasoundorder',
            index=models.Index(fields=['patient', 'ordered_at'], name='ultrasound__patient_652f92_idx'),
        ),
        migrations.AddIndex(
            model_name='ultrasoundscan',
            index=models.Index(fields=['scan_number'], name='ultrasound__scan_nu_ae77a8_idx'),
        ),
        migrations.AddIndex(
            model_name='ultrasoundscan',
            index=models.Index(fields=['patient', 'created_at'], name='ultrasound__patient_6297f7_idx'),
        ),
        migrations.AddIndex(
            model_name='ultrasoundscan',
            index=models.Index(fields=['status'], name='ultrasound__status_4b7910_idx'),
        ),
    ]
