      ...
      <div className="flex items-center gap-2 md:gap-6">
        ...
        <div className="flex items-center gap-3 cursor-pointer group border-l border-gray-100 pl-2 md:pl-6">
          ...
          <div className="relative">
            <div className="h-9 w-9 md:h-10 md:w-10 rounded-full bg-teal-100 text-teal-700 flex items-center justify-center shadow-sm border border-teal-200 group-hover:bg-primary group-hover:text-white transition-all overflow-hidden">
                {user?.profile_image ? (
