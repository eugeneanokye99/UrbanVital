      ...
      >
        ...
        <div className="px-6 py-4">
          <div className="bg-white/10 rounded-lg p-3 flex items-center gap-3 border border-white/5 backdrop-blur-sm">
             {/* Fixed: Changed bg-indigo-500/20 to bg-white/20 and text-indigo-300 to text-white */}
             ...
             <div>
                ...
                <p className="text-white/70 text-[10px]">Ultrasound Unit</p>
             </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-white/10">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-red-100 hover:text-white hover:bg-red-500/20 rounded-xl transition-all"
          >
            <LogOut size={20} />
