                ...
                <div className="flex-1 overflow-y-auto">
                  {filteredPatients.length > 0 ? (
                    ...
                    <div className="p-8 text-center">
                      ...
                      <button
                        onClick={() =>
                          (window.location.href = "/staff/registerpatient")
                        }
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <div className="relative">
                            ...
                            />
                            <select
                              className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#073159] outline-none appearance-none text-sm"
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <CreditCard
                              ...
                              size={18}
                            />
                            <select className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#073159] outline-none appearance-none text-sm">
