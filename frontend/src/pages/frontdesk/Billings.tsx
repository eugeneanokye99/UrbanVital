                ...
                {selectedBill ? (
                  <div className="flex-1 flex flex-col h-full">
                    ...
                    <div className="flex-1 flex flex-col xl:flex-row overflow-hidden">
                      ...
                      {/* 2. Breakdown List (Left side of terminal) */}
                      ...
                      {/* 3. Payment Action Area (Right side of terminal) */}
                      {/* FIX: Added overflow-y-auto here to handle small screens/large content */}
