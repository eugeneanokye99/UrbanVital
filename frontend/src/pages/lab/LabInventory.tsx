      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm md:text-base text-gray-500 mt-1">
            Track reagents, consumables, and expiry dates.
          </p>
        </div>
        <button className="w-full sm:w-auto bg-[#073159] text-white px-6 py-2.5 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-[#062a4d] shadow-lg text-sm md:text-base transition-transform active:scale-95">
