...
export default function LabPatientProfile() {
  ...
  const patient = location.state?.patient; // Assuming patient object is passed via navigation state
  ...
  if (!patient) return <div className="p-8 text-center text-gray-500">Patient data not found. Please navigate from the patient list.</div>;
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-4 border-b border-gray-100 flex items-center gap-2 bg-gray-50/50">
              ...
              <h3 className="font-bold text-gray-800 text-sm md:text-base">Test History</h3>
            </div>
