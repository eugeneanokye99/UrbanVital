        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#073159] text-white p-5 md:p-6 rounded-t-2xl flex flex-col sm:flex-row justify-between items-start sm:items-center shadow-lg gap-4">
              ...
              <div className="bg-white/10 px-4 py-2 rounded-lg text-xs font-bold border border-white/20 whitespace-nowrap">
                Sample ID: #SMP-9921
              </div>
            </div>
            ...
            <div className="bg-white p-5 md:p-8 rounded-b-2xl shadow-sm border border-gray-100 border-t-0">
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                ...
                <textarea 
                  className="w-full p-4 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white outline-none focus:border-[#073159] text-sm transition-colors"
                  rows={3}
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-end gap-3 sm:gap-4">
                <button className="w-full sm:w-auto px-6 py-3 rounded-xl border border-gray-300 text-gray-600 font-bold hover:bg-gray-50 transition-colors order-2 sm:order-1">
                  Cancel
                </button>
    ...
    <div>
      ...
      <div className="relative">
        <input 
          ...
          placeholder="0.0"
        />
        <span className="absolute right-3 top-3 text-sm text-gray-400 font-bold">{unit}</span>
      </div>
      {(isHigh || isLow) && (
