                    ...
                    <div key={rx.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col hover:shadow-md transition-shadow">
                        ...
                        <div className="p-4 border-t border-gray-100 bg-gray-50 flex justify-end">
                            {rx.dispenseStatus === "Pending" ? (
                                rx.paymentStatus === "Paid" ? (
                                    <button className="bg-[#073159] text-white px-4 sm:px-6 py-2 rounded-lg font-bold text-xs sm:text-sm hover:bg-[#062a4d] flex items-center gap-2 shadow-lg shadow-blue-900/10 w-full justify-center sm:w-auto">
