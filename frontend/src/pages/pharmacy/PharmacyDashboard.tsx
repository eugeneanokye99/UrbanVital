...
const MOCK_DATA = [
  {
    id: "RX-1001",
    patient_name: "Sarah Mensah",
    patient_id_number: "P-2024-001",
    doctor_name: "Dr. Opoku",
    status: "Pending", 
    created_at: new Date().toISOString(),
    total_amount: 150.00,
    items: [
      { description: "Amoxicillin 500mg", quantity: 21 },
      { description: "Paracetamol 500mg", quantity: 30 }
    ]
  },
  {
    id: "RX-1002",
    patient_name: "Emmanuel Osei",
    patient_id_number: "P-2024-005",
    doctor_name: "Dr. Ama",
    status: "Pending",
    created_at: new Date(Date.now() - 3600000).toISOString(),
    total_amount: 45.00,
    items: [
      { description: "Artemether-Lumefantrine", quantity: 1 }
    ]
  },
  {
    id: "RX-1003",
    patient_name: "John Doe",
    patient_id_number: "P-2024-012",
    doctor_name: "Dr. Kwame",
    status: "Paid", 
    created_at: new Date().toISOString(), 
    total_amount: 320.00,
    items: [
      { description: "Lipitor 20mg", quantity: 30 },
      { description: "Metformin 500mg", quantity: 60 }
    ]
  },
  {
    id: "RX-1004",
    patient_name: "Grace Antwi",
    patient_id_number: "P-2024-008",
    doctor_name: "Dr. Opoku",
    status: "Paid",
    created_at: new Date(Date.now() - 86400000 * 2).toISOString(), 
    total_amount: 85.50,
    items: [
      { description: "Cough Syrup", quantity: 2 },
      { description: "Vitamin C", quantity: 1 }
    ]
  },
  {
    id: "RX-1005",
    patient_name: "Kwesi Arthur",
    patient_id_number: "P-2024-022",
    doctor_name: "Dr. Mensah",
    status: "Pending",
    created_at: new Date().toISOString(),
    total_amount: 210.00,
    items: [
      { description: "Ibuprofen 400mg", quantity: 20 },
      { description: "Antibiotic Cream", quantity: 1 },
      { description: "Bandages", quantity: 5 }
    ]
  }
];
...
const MOCK_TOP_DRUGS = [
    { name: "Paracetamol 500mg", count: 1240, percentage: 95 },
    { name: "Amoxicillin Caps", count: 850, percentage: 70 },
    { name: "Cough Syrup", count: 620, percentage: 55 },
    { name: "Vitamin C", count: 480, percentage: 40 },
    { name: "Artemether-Lum", count: 310, percentage: 25 },
];
          ...
          <div className="flex w-full sm:w-auto bg-gray-100 p-1 rounded-xl shadow-inner border border-gray-200 max-w-md mb-6">
              <button 
                ...
                className={`flex-1 px-4 py-2 text-sm font-bold rounded-lg transition-all ${
                  activeTab === "pending" ? "bg-white text-[#073159] shadow-sm" : "text-gray-500 hover:text-gray-800"
                }`}
              >
              ...
              <button 
                ...
                className={`flex-1 px-4 py-2 text-sm font-bold rounded-lg transition-all ${
                  activeTab === "history" ? "bg-white text-[#073159] shadow-sm" : "text-gray-500 hover:text-gray-800"
                }`}
              >
                Completed History
              </button>
