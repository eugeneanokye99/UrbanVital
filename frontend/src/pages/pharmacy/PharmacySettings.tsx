      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8">
          <div className="max-w-5xl mx-auto">
            ...
            <h1 className="text-xl md:text-2xl font-bold text-[#073159] mb-6">Pharmacy Configuration</h1>
                  ...
                  {activeTab === "profile" && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                      ...
                      <div className="pt-4 flex justify-end">
                        <button className="bg-[#073159] text-white px-6 py-2.5 rounded-xl font-bold text-sm flex items-center gap-2 hover:bg-[#062a4d] shadow-lg shadow-blue-900/20 w-full sm:w-auto justify-center">
