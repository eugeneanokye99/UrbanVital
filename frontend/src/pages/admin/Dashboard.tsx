      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          <button 
            ...
            className="flex-1 lg:flex-none flex justify-center items-center gap-2 px-4 py-3 bg-blue-50 text-blue-700 rounded-xl hover:bg-blue-100 transition-colors font-bold text-sm active:scale-95"
          >
            <UserPlus size={18} />
            <span>Add Staff</span>
          </button>
