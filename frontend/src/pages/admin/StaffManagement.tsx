            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
              <div>
                <h1 className="text-xl md:text-2xl font-bold text-[#073159] flex items-center gap-2">
                  <Shield className="w-6 h-6 text-[#073159]" />
                  Staff Directory
                </h1>
                <p className="text-sm text-gray-500 mt-1">Manage user access, roles, and account status.</p>
              </div>
              <button 
                onClick={() => navigate("/admin/register")}
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 bg-[#073159] text-white rounded-xl hover:bg-[#062a4d] transition-colors shadow-lg shadow-blue-900/20 font-medium text-sm active:scale-95"
              >
                <UserPlus size={18} />
                      ...
                      <tr key={staff.id} className="hover:bg-blue-50/30 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right">
                           <div className="flex items-center justify-end gap-2">
                              <button className="p-2 text-gray-400 hover:text-[#073159] hover:bg-gray-100 rounded-lg transition-colors">
                                 <Edit size={16} />
                              </button>
