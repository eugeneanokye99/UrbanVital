...
// --- Updated Mock Data with 'patientType' ---
const MOCK_SALES = [
    { id: "RX-2023-001", patient: "Kwame Mensah", patientType: "Registered", doctor: "Dr. Agyeman", date: "2023-10-25 09:30", items: 3, total: 45.00, payment: "Cash", status: "Dispensed", drugs: [{name: "Paracetamol 500mg", qty: 20, price: 10}, {name: "Amoxicillin", qty: 15, price: 35}] },
    { id: "RX-2023-002", patient: "Ama Osei", patientType: "Registered", doctor: "Dr. Mensah", date: "2023-10-25 10:15", items: 1, total: 120.00, payment: "Insurance", status: "Pending", drugs: [{name: "Metformin 500mg", qty: 60, price: 120}] },
    { id: "RX-2023-003", patient: "John Doe", patientType: "Walk-In", doctor: "-", date: "2023-10-25 11:00", items: 2, total: 25.00, payment: "Cash", status: "Dispensed", drugs: [{name: "Cough Syrup", qty: 1, price: 15}, {name: "Vitamin C", qty: 10, price: 10}] },
];
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto">
                ...
                <div className="grid grid-cols-2 gap-6 mb-8 p-4 bg-blue-50/30 rounded-xl border border-blue-100">
                    ...
                    <div>
                        <span className="text-xs font-bold text-gray-400 uppercase block mb-1">Prescriber</span>
                        <p className="font-bold text-gray-800">{viewingSale.doctor}</p>
                    </div>
                    <div>
