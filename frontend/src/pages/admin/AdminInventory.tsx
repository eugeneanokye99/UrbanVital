  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 md:space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-gray-200 text-[#073159] rounded-xl hover:bg-gray-50 transition-colors font-bold text-sm shadow-sm active:scale-95 transform">
          <Download size={18} />
