      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <h1 className="text-2xl font-bold text-[#073159] mb-6 flex items-center gap-2">
               <CreditCard className="w-7 h-7" /> Service Billing
            </h1>
              ...
              <div className="lg:col-span-1">
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                  ...
                  <form className="space-y-4">
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1">Patient Name / MRN</label>
                      <div className="relative">
                        <Search className="absolute left-3 top-3 text-gray-400" size={18} />
                        <input 
                          type="text" 
                          placeholder="Search patient..."
                          className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#073159] outline-none transition-all"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <select className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#073159] outline-none cursor-pointer">
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1">Cost (GHS)</label>
                      <div className="relative">
                        <span className="absolute left-4 top-2.5 text-gray-500 font-bold">₵</span>
                        <input 
                          type="number" 
                          placeholder="0.00"
                          className="w-full pl-8 pr-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#073159] outline-none transition-all font-mono font-medium"
                        />
                      </div>
                    </div>
                    ...
                    <button className="w-full bg-[#073159] text-white py-3 rounded-xl font-bold shadow-md hover:bg-[#062a4d] transition-transform active:scale-95">
                      Add to Invoice
                    </button>
                  </form>
                </div>
                    ...
                    <tbody className="divide-y divide-gray-100 text-sm">
                      {recentCharges.map((charge) => (
                        <tr key={charge.id} className="hover:bg-gray-50">
                          <td className="px-6 py-3 text-gray-500 font-mono text-xs">{charge.time}</td>
                          <td className="px-6 py-3 font-medium text-gray-800">{charge.patient}</td>
